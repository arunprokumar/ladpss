...
(function() {
    ...
    function displayDataOnPage(resultData) {
        ...
        for (var i = 0; i < dataCount; i++) {
            LIST_GROUP += "<li class='cmp-searchresult-item'><div class='cmp-searchresult-title heading--medium'><a class='cmp-searchresult-link' target='_blank' href=" + checkNull(data[i].url) + ">" + checkNull(data[i].title) + "</a></div><span class='cmp-searchresult-tags'>" + checkNull(data[i].tags) + "<span class='cmp-searchresult-date'>" + checkNull(data[i].formattedLastModifiedDate) + "</span> <p class='cmp-searchresult-description'>" + checkNull(data[i].description) + "</p></li>";
        }
